...
const struct Achievement achievements[] = {
    ...
    {"âäÇÃèÿ", "ÉXÉgÅ[ÉäÅ[ëÊÇQïîÉNÉäÉA", isBook2Clear, ProgressAchievement, BronzeAchievement, 0},
    ...
    {"ã@ÇÃèÿ", "ÉXÉgÅ[ÉäÅ[ëÊÇTïîÉNÉäÉA", isBook5Clear, ProgressAchievement, GoldAchievement, 0},
