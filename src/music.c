...
const struct SoundRoomEntry soundRoomEntries[] = {
    ...
    {MUSIC_EVENT_SERIOUS_3, 99 * 0x30,                   0, "ÉCÉxÉìÉgãŸí£éO"},
    {MUSIC_MAP_FE03, 77 * 0x30,                          0, "åàãNÇÃéû"},
    {MUSIC_FE_IF_LOST_IN_THOUGHTS_ALL_ALONE, 355 * 0x30, 0, "Ç–Ç∆ÇËévÇ§"},
    {MUSIC_FE_H_EVENT_1, 115 * 0x30,                     0, "ÉCÉxÉìÉgàÍ"},
    {MUSIC_FE_H_GEAR_UP, 219 * 0x30,                     0, "èÄîı"},
    {MUSIC_FE_H_MAP_BOOK_2, 226 * 0x30,                  0, "ëÊìÒïîÉ}ÉbÉv"},
    ...
    {MUSIC_FE_AWAKENING_MAIN_THEME_TITLE, MUSIC_LENGTH(0, 28), 0, "Ç©Ç≠ÇπÇ¢Å@ÉÅÉCÉìÉeÅ[É}É^ÉCÉgÉã"},
    {MUSIC_FE_AWAKENING_YOU_CAN_CALL_ME_MARTH, MUSIC_LENGTH(1, 25), 0, "ñlÇÃñºÇÕÉ}ÉãÉXÇæ"},
    {MUSIC_FE_PATH_OF_RADIANCE_LIKE_FATHER_LIKE_SON, MUSIC_LENGTH(1, 45), 0, "Ç±ÇÃïÉÇ…ÇµÇƒÇ±ÇÃéqÇ†ÇË"},
    {MUSIC_FE_PATH_OF_RADIANCE_POWER_HUNGRY_FOOL, MUSIC_LENGTH(3, 8), 0, "ÇoÇèÇóÇÖÇíÇàÇïÇéÇáÇíÇôÅ@ÇeÇèÇèÇå"},
    {MUSIC_FE_GAIDEN_CELICA_MAP_1, MUSIC_LENGTH(1, 21), 0, "É~ÉâÇÃâ¡åÏÇ∆Ç∆Ç‡Ç…"},
    {MUSIC_FE_GAIDEN_FINAL_MAP, MUSIC_LENGTH(1, 24), 0, "ê_ÇÊÅAÇªÇÃÇΩÇªÇ™ÇÍÇÊ"},
    {MUSIC_FE_GAIDEN_SEPARATE_WAYS, MUSIC_LENGTH(2, 11), 0, "ÇªÇÍÇºÇÍÇÃìπ"},
    {MUSIC_FE_GAIDEN_ENCOUNTER, MUSIC_LENGTH(1, 28), 0, "äOì`Å@èoâÔÇ¢"},
    {MUSIC_FE_PATH_OF_RADIANCE_BEAUTIFUL_PRINCESS_ELINCIA, MUSIC_LENGTH(2, 26), 0, "ÇaÇÖÇÅÇïÇîÇâÇÜÇïÇåÅ@ÇoÇíÇâÇéÇÉÇÖÇìÇìÅ@ÇdÇåÇâÇéÇÉÇâÇÅ"},
    {MUSIC_FE_PATH_OF_RADIANCE_LIFE_RETURNS, MUSIC_LENGTH(4, 22), 0, "ÇkÇâÇÜÇÖÅ@ÇqÇÖÇîÇïÇíÇéÇì"},
