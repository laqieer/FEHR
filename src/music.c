...
const struct SoundRoomEntry soundRoomEntries[] = {
    ...
    {MUSIC_FE_THREE_HOUSE_BLUE_SKIES_AND_A_BATTLE, MUSIC_LENGTH(5, 42), 0, "鷲獅子たちの蒼空"},
    {MUSIC_FE_THREE_HOUSE_BROKEN_ROUTINE, MUSIC_LENGTH(4, 43), 0, "壊された日常"},
    {MUSIC_FE_THREE_HOUSE_CHASING_DAYBREAK, MUSIC_LENGTH(4, 23), 0, "野望の地平"},
