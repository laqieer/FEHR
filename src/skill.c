...
const struct PassiveSkill passiveSkillAs[] = {
    ...
    {"遠きょり反撃", "敵から攻撃された時、距離に関係なく反撃する", "Distant Counter", "Unit can counterattack regardless of foe's range."},
    ...
    {"近きょり反撃", "敵から攻撃された時、距離に関係なく反撃する", "Close Counter", "Unit can counterattack regardless of foe's range."},
};
