...
const struct PassiveSkill passiveSkillAs[] = {
    ...
    {"攻撃速さこん身１", "戦闘開始時、自身のＨＰが全部なら攻撃、速さ＋３、その状態で攻撃した時、戦闘後、自分に１ダメージ", "Atk/Spd Push 1", "At start of combat, if unit's HP = 100%, grants Atk/Spd+3, but if unit attacked, deals 1 damage to unit after combat."},
    {"攻撃速さこん身２", "戦闘開始時、自身のＨＰが全部なら攻撃、速さ＋４、その状態で攻撃した時、戦闘後、自分に１ダメージ", "Atk/Spd Push 2", "At start of combat, if unit's HP = 100%, grants Atk/Spd+4, but if unit attacked, deals 1 damage to unit after combat."},
    {"攻撃速さこん身３", "戦闘開始時、自身のＨＰが全部なら攻撃、速さ＋５、その状態で攻撃した時、戦闘後、自分に１ダメージ", "Atk/Spd Push 3", "At start of combat, if unit's HP = 100%, grants Atk/Spd+5, but if unit attacked, deals 1 damage to unit after combat."},
    {"攻撃速さこん身４", "戦闘開始時、自身のＨＰが４分の１以上なら攻撃、速さ＋７、その状態で攻撃した時、戦闘後、自分に５ダメージ", "Atk/Spd Push 4", "At start of combat, if unit's HP >= 25%, grants Atk/Spd+7, but if unit attacked, deals 5 damage to unit after combat."},
};
