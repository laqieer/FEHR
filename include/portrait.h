...
typedef struct Portrait {
    ...
    const u8 *card; // class card / bg (80 x 72)
    const u16 *bg; // bg map (only when card is Null)
    const u16 *mask; // bg mask (only when card is Null)
} Portrait;
...
#define DEFINE_PORTRAIT_WITH_BG(name) const Portrait portrait##name = {portrait_##name##_tilesetTiles, portrait_##name##_miniTiles, portrait_##name##_tilesetPal, portrait_##name##_obj, portrait_##name##_bgTiles, 0, 0};
...
#define DEFINE_PORTRAIT_SPECIAL_WITHOUT_MASK_RECOLOR(name, base) const Portrait portrait##name = {portrait_##base##_tilesetTiles, portrait_##base##_miniTiles, portrait_##name##Pal, portrait_##base##_obj, 0, portrait_##base##_bg, PORTRAIT_NO_MASK};
