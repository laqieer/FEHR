...
enum PassiveSkillAID {
    ...
    PASSIVE_SKILL_A_HELL_SCYTHE, // 死鎌
    PASSIVE_SKILL_A_FLOWER_OF_JOY_1, // 幸福の花
    PASSIVE_SKILL_A_FLOWER_OF_JOY_2,
    PASSIVE_SKILL_A_FLOWER_OF_JOY_3,
    PASSIVE_SKILL_A_FLOWER_OF_JOY_4,
    PASSIVE_SKILL_A_FLOWER_OF_SORROW_1, // 不幸の花
    PASSIVE_SKILL_A_FLOWER_OF_SORROW_2,
    PASSIVE_SKILL_A_FLOWER_OF_SORROW_3,
    PASSIVE_SKILL_A_FLOWER_OF_SORROW_4,
    PASSIVE_SKILL_A_FLOWER_OF_PLENTY_1, // 豊潤の花
    PASSIVE_SKILL_A_FLOWER_OF_PLENTY_2,
    PASSIVE_SKILL_A_FLOWER_OF_PLENTY_3,
    PASSIVE_SKILL_A_FLOWER_OF_PLENTY_4,
    PASSIVE_SKILL_A_FLOWER_OF_EASE_1, // 微睡の花
    ...
    PASSIVE_SKILL_A_ATK_SPD_SOLO_1, // 攻撃速さの孤軍
    PASSIVE_SKILL_A_ATK_SPD_SOLO_2,
    PASSIVE_SKILL_A_ATK_SPD_SOLO_3,
    PASSIVE_SKILL_A_ATK_SPD_SOLO_4,
    PASSIVE_SKILL_A_LUCK_1, // 幸運
    PASSIVE_SKILL_A_LUCK_2,
    PASSIVE_SKILL_A_LUCK_3,
    PASSIVE_SKILL_A_LUCK_4,
    PASSIVE_SKILL_A_CLOSE_COUNTER, // 近距離反撃
    PASSIVE_SKILL_A_LOFNHEIOR_1, // ロヴンヘイズ
    PASSIVE_SKILL_A_LOFNHEIOR_2,
    PASSIVE_SKILL_A_LOFNHEIOR_3,
    PASSIVE_SKILL_A_LOFNHEIOR_4,
    PASSIVE_SKILL_A_ATK_SPD_PUSH_1, // 攻撃速さの渾身
    PASSIVE_SKILL_A_ATK_SPD_PUSH_2,
    PASSIVE_SKILL_A_ATK_SPD_PUSH_3,
    PASSIVE_SKILL_A_ATK_SPD_PUSH_4,
    PASSIVE_SKILL_A_ATK_RES_SOLO_1, // 攻撃魔防の孤軍
    PASSIVE_SKILL_A_ATK_RES_SOLO_2,
    PASSIVE_SKILL_A_ATK_RES_SOLO_3,
    PASSIVE_SKILL_A_ATK_RES_SOLO_4,
    PASSIVE_SKILL_A_ATK_DEF_CATCH_1, // 攻撃守備の機先
    PASSIVE_SKILL_A_ATK_DEF_CATCH_2,
    PASSIVE_SKILL_A_ATK_DEF_CATCH_3,
    PASSIVE_SKILL_A_ATK_DEF_CATCH_4,
    PASSIVE_SKILL_A_ATK_DEF_UNITY, // 攻撃守備の連帯
};
...
enum PassiveSkillBID {
    ...
    PASSIVE_SKILL_B_GUARD_BEARING_1, // 警戒姿勢
    PASSIVE_SKILL_B_GUARD_BEARING_2,
    PASSIVE_SKILL_B_GUARD_BEARING_3,
    PASSIVE_SKILL_B_GUARD_BEARING_4,
    PASSIVE_SKILL_B_AEROBATICS_1, // 曲技飛行
    PASSIVE_SKILL_B_AEROBATICS_2,
    PASSIVE_SKILL_B_AEROBATICS_3,
    PASSIVE_SKILL_B_AEROBATICS_4,
    PASSIVE_SKILL_B_SABOTAGE_DEF_1, // 守備の混乱
    PASSIVE_SKILL_B_SABOTAGE_DEF_2,
    PASSIVE_SKILL_B_SABOTAGE_DEF_3,
    PASSIVE_SKILL_B_SABOTAGE_DEF_4,
    PASSIVE_SKILL_B_BINDING_NECKLACE, // 束縛の首飾り
    PASSIVE_SKILL_B_SABOTAGE_SPD_1, // 速さの混乱
    ...
    PASSIVE_SKILL_B_DIVINE_RECREATION, // それは興味深いね
    PASSIVE_SKILL_B_A_D_NEAR_TRACE_1, // 攻撃守備の近影
    PASSIVE_SKILL_B_A_D_NEAR_TRACE_2,
    PASSIVE_SKILL_B_A_D_NEAR_TRACE_3,
    PASSIVE_SKILL_B_A_D_NEAR_TRACE_4,
    PASSIVE_SKILL_B_LULL_ATK_DEF_1, // 攻撃守備の凪
    PASSIVE_SKILL_B_LULL_ATK_DEF_2,
    PASSIVE_SKILL_B_LULL_ATK_DEF_3,
    PASSIVE_SKILL_B_LULL_ATK_DEF_4,
};
...
enum PassiveSkillCID {
    ...
    PASSIVE_SKILL_C_INEVITABLE_DEATH, // 死からは逃れられぬ
    PASSIVE_SKILL_C_FORTIFY_RES_1, // 魔防の鼓舞
    PASSIVE_SKILL_C_FORTIFY_RES_2,
    PASSIVE_SKILL_C_FORTIFY_RES_3,
    PASSIVE_SKILL_C_FORTIFY_RES_4,
    PASSIVE_SKILL_C_DEF_RES_GAP_1, // 守備魔防の大開放
    PASSIVE_SKILL_C_DEF_RES_GAP_2,
    PASSIVE_SKILL_C_DEF_RES_GAP_3,
    PASSIVE_SKILL_C_DEF_RES_GAP_4,
    PASSIVE_SKILL_C_PULSE_SMOKE_1, // 鼓動の幻煙
    PASSIVE_SKILL_C_PULSE_SMOKE_2,
    PASSIVE_SKILL_C_PULSE_SMOKE_3,
    PASSIVE_SKILL_C_PULSE_SMOKE_4,
    PASSIVE_SKILL_C_FIRE_EMBLEM_1, // ファイアーエムブレム
    PASSIVE_SKILL_C_FIRE_EMBLEM_2,
    PASSIVE_SKILL_C_FIRE_EMBLEM_3,
    PASSIVE_SKILL_C_FIRE_EMBLEM_4,
    PASSIVE_SKILL_C_THREATEN_SPD_1, // 速さの威嚇
    PASSIVE_SKILL_C_THREATEN_SPD_2,
    PASSIVE_SKILL_C_THREATEN_SPD_3,
    PASSIVE_SKILL_C_THREATEN_SPD_4,
    PASSIVE_SKILL_C_ATK_RES_REIN_1, // 攻撃魔防の牽制
    PASSIVE_SKILL_C_ATK_RES_REIN_2,
    PASSIVE_SKILL_C_ATK_RES_REIN_3,
    PASSIVE_SKILL_C_ATK_RES_REIN_4,
    PASSIVE_SKILL_C_SPD_RES_REIN_1, // 速さ魔防の牽制
    PASSIVE_SKILL_C_SPD_RES_REIN_2,
    PASSIVE_SKILL_C_SPD_RES_REIN_3,
    PASSIVE_SKILL_C_SPD_RES_REIN_4,
    PASSIVE_SKILL_C_THREATEN_DEF_1, // 守備の威嚇
    PASSIVE_SKILL_C_THREATEN_DEF_2,
    PASSIVE_SKILL_C_THREATEN_DEF_3,
    PASSIVE_SKILL_C_THREATEN_DEF_4,
    PASSIVE_SKILL_C_THREAT_ATK_DEF_1, // 攻撃守備の威嚇
    PASSIVE_SKILL_C_THREAT_ATK_DEF_2,
    PASSIVE_SKILL_C_THREAT_ATK_DEF_3,
    PASSIVE_SKILL_C_ATK_DEF_MENACE, // 攻撃守備の脅嚇
    PASSIVE_SKILL_C_EVEN_TEMPEST_1, // 迅雷風烈・偶数
    PASSIVE_SKILL_C_EVEN_TEMPEST_2,
    PASSIVE_SKILL_C_EVEN_TEMPEST_3,
    PASSIVE_SKILL_C_EVEN_TEMPEST_4,
    PASSIVE_SKILL_C_THREAT_ATK_SPD_1, // 攻撃速さの威嚇
    PASSIVE_SKILL_C_THREAT_ATK_SPD_2,
    PASSIVE_SKILL_C_THREAT_ATK_SPD_3,
    PASSIVE_SKILL_C_ATK_SPD_MENACE, // 攻撃速さの脅嚇
    PASSIVE_SKILL_C_OPENING_RETAINER, // 開神の眷属
};
...
enum PassiveSkillSID {
    ...
    PASSIVE_SKILL_S_HARDY_BEARING, // 不動の姿勢
    PASSIVE_SKILL_S_ARMORED_BOOTS, // 重装のブーツ
    PASSIVE_SKILL_S_NIGHTMARE, // 悪夢
    PASSIVE_SKILL_S_SUREFOOTED, // 悪路踏破
    PASSIVE_SKILL_S_GRANIS_SHIELD, // グラニの盾
    PASSIVE_SKILL_S_NIOAVELLIR_AXIOM, // ニザヴェリルの理
};
